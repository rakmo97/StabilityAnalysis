...
# x = layers.Dense(n_neurons, activation=activation, kernel_initializer='normal')(inputs)
# # x = layers.Dense(n_neurons, activation=activation, kernel_initializer='normal')(x)
...
x = LN.LyapunovDense(2*nNeurons)(x)
x = LN.LyapunovDense(3*nNeurons)(x)
outputs = Dot(axes=1)([x, x])
...
saveflag = 'LyBasic_Max_{}n'.format(nNeurons)
