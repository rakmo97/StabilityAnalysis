...
# policy_filename = base_data_folder+formulation+'NetworkTraining/trainThetaPhi_MCLyapunov_5break_tight_ANN2_703_tanh_n100.h5'
# policy_filename = base_data_folder+formulation+'NetworkTraining/trainThetaPhi_MCLyapunov_5break_ANN2_703_tanh_n100.h5'
# policy_filename = base_data_folder+formulation+'NetworkTraining/trainThetaPhi_MCLyapunov_5break_normal_ANN2_703_tanh_n100.h5'
policy_filename = base_data_folder+formulation+'NetworkTraining/trainThetaPhi_MCLyapunov_10break_normal_ANN2_703_tanh_n100.h5'

policy = models.load_model(policy_filename)

# lyapunov_filename = base_data_folder + formulation + "NetworkTraining/AggregateLearningMC_Aggregate_Learning.h5"
# lyapunov_filename = base_data_folder + formulation + "NetworkTraining/AggregateLearningMC_Aggregate_Learning_320n.h5"
# lyapunov_filename = base_data_folder + formulation + "NetworkTraining/AggregateLearningMC_Aggregate_Learning_120n.h5"
# lyapunov_filename = base_data_folder + formulation + "NetworkTraining/AggregateLearningMC_Aggregate_Learning_100n.h5"
# lyapunov_filename = base_data_folder + formulation + "NetworkTraining/trainThetaPhi_MCLyapunov__Lyappunov.h5"
# lyapunov_filename = base_data_folder + formulation + "NetworkTraining/trainThetaPhi_MCLyapunov_5break_tight__Lyappunov.h5"
# lyapunov_filename = base_data_folder + formulation + "NetworkTraining/trainThetaPhi_MCLyapunov_5break__Lyappunov.h5"
# lyapunov_filename = base_data_folder + formulation + "NetworkTraining/trainThetaPhi_MCLyapunov_5break_normal__Lyappunov.h5"
lyapunov_filename = base_data_folder + formulation + "NetworkTraining/trainThetaPhi_MCLyapunov_10break_normal__Lyappunov.h5"
