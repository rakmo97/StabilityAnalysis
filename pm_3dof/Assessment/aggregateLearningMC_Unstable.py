...
# lyapunov_filename = base_data_folder + formulation + "NetworkTraining/MinimizedLyapunovNetwork_MSE_LyBasic_Max_120n.h5"
# saveflag = 'Aggregate_Learning_120n'
lyapunov_filename = base_data_folder + formulation + "NetworkTraining/MinimizedLyapunovNetwork_MSE_LyBasic_Max_100n.h5"
saveflag = 'Aggregate_Learning_Unstable'
...
for episode in range(episodes):
    ...
    # X_list = np.random.uniform(low=lower1,high=upper1,size=(pos_to_aggregate,nState))
    ...
    y_train = np.vstack((y_train, policy(X_list).numpy()))
...
print("\nSaving ANN!")
saveout_filename = base_data_folder + formulation + "NetworkTraining/AggregateLearningMC_{}.h5".format(saveflag)
