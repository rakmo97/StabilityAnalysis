...
for episode in range(episodes):
    ...
    X_MC_np_val = np.random.uniform(low=lower,high=upper,size=(MC_num_train,nState))
...
print("\nSaving Lyapunov!")
saveout_filename = base_data_folder + formulation + "NetworkTraining/{}_Lyappunov.h5".format(saveflag)
print('Filename: ' + saveout_filename)
